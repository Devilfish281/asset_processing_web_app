# src/asset_processing_service/media_processor.py
# This file contains functions for processing media files, including splitting audio files into chunks,
#  converting audio to MP3 format, extracting audio from video files, and
# transcribing audio chunks using OpenAI's Whisper model.
# The functions are designed to be asynchronous and use ffmpeg for audio
import asyncio
import os
import shutil
import tempfile
        ...
        try:
            ...
            with open(temp_file_path, "rb") as audio_file:
                ...
                transcription = client.audio.transcriptions.create(
                    model=setup_config.openai_model, file=audio_file
                )
